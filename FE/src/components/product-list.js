...
export default function ProductList() {
    ...
    // 1. CẤU HÌNH API
    const API_URL = "http://127.0.0.1:8000/api/san-pham";
    ...
    return (
        <div className="w-full max-w-7xl mx-auto px-4 py-8">
            <h2 className="font-display text-2xl md:text-3xl font-bold text-blue-900 mb-6 flex items-center gap-2">
                <span className="material-symbols-outlined text-blue-600 text-3xl">water_full</span>
                Sản phẩm tươi sống
            </h2>
                                    ...
                                    <div className="p-4 flex flex-col flex-grow">
                                        <div className="flex-grow">
                                            ...
                                            <p className="font-bold text-blue-600 text-xl mt-auto">
                                                {price ? (
                                                    <>
                                                        {Number(price).toLocaleString('vi-VN')}đ <span className="text-sm font-normal text-slate-400">/ kg</span>
                                                    </>
                                                ) : (
                                                    <span className="text-base text-blue-500">Liên hệ</span>
                                                )}
                                            </p>
                                        </div>

  ...
  return (
    ...
    <footer className="w-full bg-[#0f172a] text-white border-t border-white/10 mt-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-10 flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
          <div className="text-center md:text-left">
            ...
            <p className="text-xs sm:text-sm text-slate-400 mt-1">
              Nhận ưu đãi độc quyền và cập nhật mới nhất từ Minh Quân Fresh.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row w-full md:w-auto gap-2">
            <input
              ...
              className="w-full sm:w-64 md:w-80 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg border border-white/10 bg-white/5 text-white text-sm placeholder:text-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
            />
            <button className="px-4 sm:px-6 py-2 sm:py-2.5 rounded-lg bg-blue-600 text-white font-bold text-xs sm:text-sm hover:bg-blue-500 transition-colors duration-300 shadow-lg whitespace-nowrap">
              Đăng ký
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center gap-2">
              <div className="flex items-center justify-center size-9 sm:size-10 rounded-lg bg-blue-600 text-white flex-shrink-0">
          ...
          {/* Links Column 1 */}
          <div>
            <h4 className="font-display font-bold text-base sm:text-lg text-white mb-3 sm:mb-4">
              Về Minh Mạnh Quân
            </h4>
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <a
                  className="text-xs sm:text-sm text-slate-400 hover:text-blue-400 hover:translate-x-1 transition-all inline-block"
                  href="#"
                >
          ...
          <div>
            ...
            <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
              <p className="flex items-start gap-2 sm:gap-3 text-xs sm:text-sm text-slate-400">
                <span className="material-symbols-outlined text-blue-500 text-base sm:text-lg mt-0.5 flex-shrink-0">
                  location_on
                </span>
                <span>123 Đường Vựa Cá, Q.1, TP.HCM</span>
              </p>
              <p className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-slate-400">
                <span className="material-symbols-outlined text-blue-500 text-base sm:text-lg flex-shrink-0">
                  call
                </span>
            ...
            <div className="flex gap-2 sm:gap-3">
              {socialLinks.map((item, index) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-center size-8 sm:size-9 rounded-full bg-white/10 text-slate-300 hover:bg-blue-600 hover:text-white transition-all duration-300"
                  title={item.name}
                >
                  {item.icon}
                </a>
      ...
      <div className="border-t border-white/10 bg-[#020617]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6 flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex gap-4 sm:gap-6">
            <a
              href="#"
              className="text-[10px] sm:text-xs text-slate-500 hover:text-blue-400 transition-colors"
            >
              Điều khoản
            </a>
            <a

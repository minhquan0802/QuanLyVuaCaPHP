...
export default function ProductDetail() {
  ...
  const handleAddToCart = () => {
    ...
    const existingItemIndex = cart.findIndex(
      (item) => item.id === productData.ma_san_pham
    );
  ...
  const getImageUrl = (urlFromDb) => {
    ...
    if (!relativePath.includes('images/loaica')) {
      const cleanFileName = relativePath.startsWith('/')
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="mb-8">
                <p className="text-4xl font-bold text-blue-600 flex items-end gap-2">
                  ...
                  <span className="text-lg font-normal text-slate-400 mb-1">
                    / kg
                  </span>
                </p>
              </div>
              ...
              <ul className="list-none space-y-4 text-slate-600">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    {productData.so_luong_ton > 0 ? 'Còn hàng' : 'Hết hàng'}
                  </span>
                </li>
              </ul>
            </div>

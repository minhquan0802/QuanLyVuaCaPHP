            ...
            <main className="flex-grow flex items-center justify-center p-4">
                <div className="bg-white p-8 md:p-12 rounded-2xl shadow-lg border border-slate-100 max-w-lg w-full text-center">
                    ...
                    <div className="flex flex-col gap-3">
                        <button onClick={() => navigate('/home')} className="w-full py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-md shadow-blue-200">
                            Về trang chủ
                        </button>
                    </div>
                </div>

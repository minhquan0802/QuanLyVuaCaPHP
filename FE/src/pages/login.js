            ...
            <div className="w-full max-w-[480px]">
                <div className="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100 p-8 md:p-10">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-500 text-sm mt-2">Thủy Sản Minh Mạnh Quân xin chào!</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="flex flex-col gap-5">
                        ...
                        <div className="space-y-1.5">
                            <label className="text-sm font-semibold text-gray-700 ml-1">Email hoặc số điện thoại</label>
                            <input
                                type="text"
                                value={email}
                        ...
                        <div className="flex justify-between items-center text-sm mt-1">
                            <label className="flex items-center gap-2 text-gray-600 cursor-pointer select-none group">
                                ...
                                <span className="group-hover:text-blue-700 transition-colors">Ghi nhớ đăng nhập</span>
                            </label>
                            <a href="#" className="text-blue-600 hover:text-blue-800 font-semibold transition-colors">Quên mật khẩu?</a>
                        </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-gray-500">
                            ...
                            <button onClick={handleRegister} className="ml-1 text-blue-600 font-bold hover:text-blue-800 hover:underline transition-all">
                                Đăng ký
                            </button>
                        </p>
                    </div>
                ...
                <div className="mt-6 text-center">
                     <p className="text-xs text-gray-400">&copy; 2024 Vựa Cá Minh Mạnh Quân</p>
                </div>
            </div>
        </div>
    )

            ...
            <main className="flex-grow">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 md:py-12">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h1 className="font-display text-3xl md:text-4xl font-bold text-blue-900 leading-tight">Thanh toán</h1>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-start">
                        ...
                        <aside className="lg:col-span-1">
                            <div className="sticky top-24 bg-white p-6 rounded-2xl shadow-lg ring-1 ring-blue-100 border-t-4 border-blue-600">
                                ...
                                <div className="flex flex-col gap-3 pt-4 border-t border-dashed border-slate-300">
                                    <div className="flex justify-between text-sm text-slate-500"><span>Tạm tính</span><span>{subtotal.toLocaleString('vi-VN')}đ</span></div>
                                    <div className="flex justify-between text-sm text-slate-500"><span>Vận chuyển</span><span>{shipping.toLocaleString('vi-VN')}đ</span></div>

                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-slate-100 text-sm text-slate-700">
                            {loading ? (
                                ...
                                products.map((item) => (
                                    <tr key={item.ma_san_pham} className="hover:bg-slate-50/80 transition-colors">
                                        <td className="p-4 text-center font-medium text-slate-500">#{item.ma_san_pham}</td>
                                        <td className="p-4">
                                        ...
                                        <td className="p-4 font-bold text-blue-900">{item.ten_san_pham}</td>
                                        <td className="p-4">
                                            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-50 text-blue-700">
                                                {/* Ưu tiên lấy từ object danh_muc nếu có, nếu không thì tìm trong list categories */}
                                                {item.danh_muc ? item.danh_muc.ten_danh_muc : getCategoryName(item.ma_danh_muc)}
                                            </span>
                                        </td>
                                        ...
                                        <td className="p-4 text-center">
                                            <span className={`font-bold ${item.so_luong_ton < 10 ? 'text-red-500' : 'text-slate-700'}`}>
                                                {item.so_luong_ton}
                                            </span>
                                        </td>
                                        <td className="p-4 text-center">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setCurrentProduct({ ...currentProduct, ten_san_pham: e.target.value })}
                                    ...
                                    <div>
                                        <label className="block text-sm font-bold text-slate-700 mb-1">Danh mục <span className="text-red-500">*</span></label>
                                        <select
                                            required
                                            value={currentProduct.ma_danh_muc}
                                            onChange={(e) => setCurrentProduct({ ...currentProduct, ma_danh_muc: e.target.value })}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setCurrentProduct({ ...currentProduct, gia_ban: e.target.value })}
                                            className="w-full px-4 py-2 rounded-lg border border-slate-200 focus:border-blue-500 outline-none"
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setCurrentProduct({ ...currentProduct, so_luong_ton: e.target.value })}
                                            className="w-full px-4 py-2 rounded-lg border border-slate-200 focus:border-blue-500 outline-none"
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setCurrentProduct({ ...currentProduct, hinh_anh: e.target.value })}
                                            className="w-full px-4 py-2 rounded-lg border border-slate-200 focus:border-blue-500 outline-none"
                                            placeholder="https://..."
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center pt-6">
                                        <label className="flex items-center gap-2 cursor-pointer">
                                            <input 
                                                ...
                                                onChange={(e) => setCurrentProduct({...currentProduct, hien_thi: e.target.checked})}
                                                className="w-5 h-5 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                                            />
                                            <span className="text-sm font-bold text-slate-700">Đang kinh doanh (Hiển thị)</span>
                                        </label>
                                    </div>

                                    {/* Mô tả */}
                                    <div className="md:col-span-2">
                                        <label className="block text-sm font-bold text-slate-700 mb-1">Mô tả sản phẩm</label>
                                        <textarea
                                            rows="4"
                                            value={currentProduct.mo_ta}
                                            onChange={(e) => setCurrentProduct({ ...currentProduct, mo_ta: e.target.value })}

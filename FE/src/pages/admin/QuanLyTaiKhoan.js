              ...
              {loading ? (
                ...
                accounts.map((item) => (
                  ...
                  >
                    ...
                    <td className="p-4">
                      <span
                        className={`px-2.5 py-1 rounded-md border text-xs font-bold ${getRoleColor(
                          item.role
                        )}`}
                      >
                    ...
                    <td className="p-4 flex justify-center gap-2">
                      <button
                        ...
                        className="size-9 flex items-center justify-center text-blue-600 hover:bg-blue-50 rounded-lg transition-colors border border-transparent hover:border-blue-100"
                        title="Chỉnh sửa"
                      >
                      ...
                      <button
                        onClick={() => handleDelete(item.ma_nguoi_dung)}
                        className="size-9 flex items-center justify-center text-red-500 hover:bg-red-50 rounded-lg transition-colors border border-transparent hover:border-red-100"
                        title="Xóa"
                      >
                        <span className="material-symbols-outlined text-[20px]">
                          delete
            ...
            >
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setCurrentUser({ ...currentUser, ho_ten: e.target.value })
                  }
                />
              </div>
              ...
              <div className="md:col-span-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setCurrentUser({ ...currentUser, mat_khau: e.target.value })
                  }
                />
              </div>
              ...
              <div className="md:col-span-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setCurrentUser({ ...currentUser, dia_chi: e.target.value })
                  }
                />
              </div>
              ...
              <div className="md:col-span-2 flex justify-end gap-3 pt-6 border-t border-slate-100 mt-2">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 rounded-xl bg-blue-600 text-white font-bold text-sm hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all active:scale-95"
                >
